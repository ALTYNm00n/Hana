...
class MenuItem(models.Model):
    menu_category = models.ForeignKey(MenuCategory, on_delete=models.CASCADE, related_name='menuitems',  blank=True, null=True)
...
class ComingSoon(models.Model):
    menu_category = models.ForeignKey(MenuCategory, on_delete=models.CASCADE, related_name='comsoon', blank=True, null=True)
...
class RestaurantInfo(models.Model):
    menu_category = models.ForeignKey(MenuCategory, on_delete=models.CASCADE, related_name='restaurants_infos',  blank=True, null=True)
    ...
    class Meta:
        verbose_name = 'О нас'
        verbose_name_plural = 'О на'

# Create a class for contact info
class ContactInfo(models.Model):
    menu_category = models.ForeignKey(MenuCategory, on_delete=models.CASCADE, related_name='contactinfos',  blank=True, null=True)
    name = models.CharField(max_length=120,verbose_name='Название',null=True, blank=True)
    email = models.EmailField(verbose_name='Почта',null=True,blank=True)
...
class ClientReview(models.Model):
    menu_category = models.ForeignKey(MenuCategory, on_delete=models.CASCADE, related_name='client_rewiwes', blank=True, null=True)
